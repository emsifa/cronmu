...
<footer class="text-sm w-full text-center mt-5 text-gray-600">
  ...
  dan
  <a class="text-teal-600 font-semibold" href="https://tailwindcss.com/" target="_blank">Tailwindcss</a>.
  Dihosting oleh
  <a class="font-semibold" class:text-gray-800={!dark} class:text-gray-300={dark} href="https://pages.github.com/" target="_blank">GitHub Page</a>.
</footer>